...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 03 nov. 2018 à 04:30
...
(51, 1, '2018-10-31 11:51:52', 'RetrouvÃ©e vivante dans le rÃ©frigÃ©rateur d\'une morgue !!!', 'Elle a Ã©tÃ© transportÃ©e a la morgue par erreur. Une femme sud-africaine a Ã©tÃ© retrouvÃ©e vivante par un employÃ© qui venait vÃ©rifier le corps, dans le rÃ©frigerateur de la morgue de Carletonville, pres de Johannesbourg, en Afrique du Sud. ', 'morgue.jpg', 1),
...
CREATE TABLE IF NOT EXISTS `profils` (
  `id_profil` tinyint(11) NOT NULL AUTO_INCREMENT,
  `id_user` int(11) NOT NULL,
...
(1, 1, 'nicolas.jpg', 'je m\'appelle nicolas h et j\'aime le chocol !!', 'Undefined', 'Nicolas', 'Haytayan'),
...
DROP TABLE IF EXISTS `skillvalue`;
CREATE TABLE IF NOT EXISTS `skillvalue` (
  `id_skillvalue` int(11) NOT NULL AUTO_INCREMENT,
  `id_user` int(11) NOT NULL,
  `skill_value` int(3) NOT NULL,
  `id_skill` int(11) NOT NULL,
  PRIMARY KEY (`id_skillvalue`),
  KEY `id_skill` (`id_skill`),
  KEY `id_user` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=297 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `skillvalue`
--
...
INSERT INTO `users` (`id_user`, `pseudo_log`, `email`, `grade`, `password_user`, `reset_pass_at`, `reset_log_at`) VALUES
(1, 'hay.nico@hotmail.fr', 'undefined@codaleague.org', 2, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(2, 'mariongely1@gmail.com', 'darkwarion@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(3, 'workdesign@outlook.fr', 'drincubator@codaleague.org', 2, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(4, 'yaya.ponsot@gmail.com', 'ironman@codaleague.com', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(5, 'gardenier.eloy30@gmail.com', 'daredevil@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(6, 'meriemdahrane@gmail.com', 'tornade@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(7, 'geoff.mirgon@gmail.fr', 'fautesdefrappe@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(8, 'victordourlot@gmail.com', 'nagraj@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(9, 'jm.daniel@gmail.fr', 'accelerator@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(10, 'luca.rosso30@gmail.com', 'droopy@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(11, 'mauryl.saintjalmes@gmail.com', 'root@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(12, 'romainfuentes1@gmail.com', 'supercc@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(13, 'delarosa.jonathan@free.fr', 'drjonathanosterman@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(14, 'enzomagnier30@gmail.com', 'mrrobot@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(15, 'rukza@orange.fr', 'taskmaster@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL),
(16, 'professeurx@codaleague.org', 'professeurx@codaleague.org', 1, '$2y$10$rVctH8uRmq5BtFnizC8xDemiYPxFPm2n0hNyIsbmJM5V0gGs.Jb6m', NULL, NULL);
